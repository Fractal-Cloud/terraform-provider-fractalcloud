...
func (f *UnmanagedFunction) Metadata(_ context.Context, _ function.MetadataRequest, resp *function.MetadataResponse) {
	resp.Name = "custom_workloads_saas_unmanaged"
}
...
func (f *UnmanagedFunction) Definition(_ context.Context, _ function.DefinitionRequest, resp *function.DefinitionResponse) {
	resp.Definition = function.Definition{
		Summary:     "Creates a SaaS Unmanaged blueprint component",
		Description: "Builds an Unmanaged (external) component with the correct type for use in a fractal's components list. No parameters, dependencies, or links.",
		Parameters: []function.Parameter{
			function.ObjectParameter{
				Name:        "config",
				Description: "SaaS Unmanaged configuration",
