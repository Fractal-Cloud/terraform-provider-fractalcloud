...
var _ function.Function = &PaaSWorkloadFunction{}

type PaaSWorkloadFunction struct{}

func NewPaaSWorkloadFunction() function.Function {
	return &PaaSWorkloadFunction{}
}

func (f *PaaSWorkloadFunction) Metadata(_ context.Context, _ function.MetadataRequest, resp *function.MetadataResponse) {
	resp.Name = "paas_workload"
}

func (f *PaaSWorkloadFunction) Definition(_ context.Context, _ function.DefinitionRequest, resp *function.DefinitionResponse) {
	resp.Definition = function.Definition{
		Summary: "Creates a PaaS Workload blueprint component",
		Description: "Builds a PaaS Workload component with the correct type for use in a fractal's components list. " +
...
type paasWorkloadConfig struct {
...
func (f *PaaSWorkloadFunction) Run(ctx context.Context, req function.RunRequest, resp *function.RunResponse) {
	var config paasWorkloadConfig
