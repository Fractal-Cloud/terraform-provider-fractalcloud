...
func (f *SecurityGroupFunction) Definition(_ context.Context, _ function.DefinitionRequest, resp *function.DefinitionResponse) {
	resp.Definition = function.Definition{
		...
		Description: "Builds a SecurityGroup component with the correct type and parameters for use in a fractal's components list. If vpc_id is provided, it is automatically added as a dependency. Ingress rules are serialized into the component parameters.",
